...
const Login = () => {
  ...
  return (
    <div>
      ...
      <form className="absolute p-12 bg-black w-3/12 my-36 mx-auto right-0 left-0 text-white rounded-3xl bg-opacity-70">
        ...
        <input 
            ...
            className="p-4 my-4 w-full bg-gray-900 rounded-xl " />
        <button className="p-4 my-4 bg-red-700 w-full rounded-xl font-bold"> {isSignInForm ? "Sign In" : "Sign Up"} </button>
